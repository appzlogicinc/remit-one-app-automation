...
public class PropFileHandler {
	...
	static String filePath = "./src/test/resources/dataFile/QA.properties";
	static String urlFilePath = "./src/test/resources/dataFile/url.properties";
	 ...
	 */
	public static String readProperty(String property) throws Exception
	{
	...
	public static String readUrl(String property) throws Exception
	{
		InputStream inPropFile = null;
		try {
			inPropFile = new FileInputStream(urlFilePath);
			properties.load(inPropFile);
		} catch (IOException e) {
			e.printStackTrace();
		}
